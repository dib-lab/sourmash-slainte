#! /usr/bin/env python
"""
Combine multiple weighted overlap reports for isolates x many metagenomes.
"""
import sys
import csv
import argparse
...
def main():
    ...
    p.add_argument('weighted_overlap_csvs', nargs='+')
    p.add_argument('-o', '--output', required=True)
    args = p.parse_args()

    df_list = []
    for filename in args.weighted_overlap_csvs:
